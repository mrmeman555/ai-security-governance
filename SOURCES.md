...
*Cited in: events/2026-04--project-glasswing.md, analysis/reasonable-security-baseline.md, system-card-summary.md, README.md*
...
*Cited in: events/2026-04--project-glasswing.md, analysis/harness-governance-gap.md, system-card-summary.md*
...
| [MEXICO-AI-INCIDENT] | Claude-based agents used against Mexican gov systems, 2025-2026 | Removed — unverified source, no longer cited |
